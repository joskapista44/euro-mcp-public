...
function register(server,deps){
 server.tool('office_xlsx_batch',
  ...
  'Supports sheet create/copy/rename/delete, range writes, format, fixed layout, merge/unmerge, freeze, sort, filter, durable validation, workbook names, conditional formatting, tested pivot create/delete, and named chart set/rename/delete with measurable presentation, position and series state. '+
