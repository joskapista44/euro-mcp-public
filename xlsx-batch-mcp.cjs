...
const operation=z.object({
 ...
 mode:z.enum(['fit_to_pages','scale','page_size']).optional(),fitToWidth:z.number().int().nonnegative().optional(),fitToHeight:z.number().int().nonnegative().optional(),scale:z.number().min(10).max(400).optional(),axis:z.enum(['rows','columns']).optional(),from:z.number().int().positive().optional(),to:z.number().int().positive().optional()
