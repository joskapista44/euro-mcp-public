...
const operation=z.object({
 ...
 sourceSheet:str.optional(),sourceRange:str.optional(),rowField:str.optional(),columnField:str.optional(),dataField:str.optional(),styleName:str.optional(),pivotSheet:str.optional(),destinationRange:str.optional(),
