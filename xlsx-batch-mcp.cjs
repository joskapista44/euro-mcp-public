...
const operation=z.object({
 ...
 mode:z.union([z.enum(['rows','columns','at']),z.enum(['fit_to_pages','scale','page_size'])]).optional(),count:z.number().int().positive().optional(),
