...
function buildShowcaseTask(runId){
 ...
 const operations=[
  ...
  {intent:'create_pivot',name:pivotName,sourceSheet:data,sourceRange:'A1:E13',rowField:'Region',columnField:'Product',dataField:'Units',styleName:'PivotStyleMedium2',assertions:[{items:['North','Core'],expected:405},{items:['North','Plus'],expected:252},{items:['South','Core'],expected:300},{items:['South','Plus'],expected:200}]},
