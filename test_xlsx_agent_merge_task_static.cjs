...
const dirty=JSON.parse(JSON.stringify(clean));dirty.cells[1][1].rawValue=9;dirty.cells[1][1].value=9;dirty.cells[1][1].displayText='9';assert.equal(agent.dataLossRisk(dirty),true)
